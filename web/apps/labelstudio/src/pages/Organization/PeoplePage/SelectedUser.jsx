  ...
  return (
    <Block name="user-info">
      <Button
        ...
        aria-label={t("organization.people.details.closeAria")}
      >
        <IconCross />
      </Button>
      ...
      {!!user.created_projects.length && (
        <Elem name="section">
          <Elem name="section-title">{t("organization.people.details.createdProjects")}</Elem>
      ...
      {!!user.contributed_to_projects.length && (
        <Elem name="section">
          <Elem name="section-title">{t("organization.people.details.contributedTo")}</Elem>
      ...
      <Elem tag="p" name="last-active">
        {t("organization.people.details.lastActivity", {
          date: format(new Date(user.last_activity), "dd MMM yyyy, KK:mm a"),
        })}
      </Elem>
    </Block>
  );
