...
export const TestRequest = ({ backend }) => {
  ...
  return (
    <section>
      ...
      >
        {t("settings.machineLearning.testRequest.send")}
      </Button>
      <Typography size="smaller" className="my-tight">
        {t("settings.machineLearning.testRequest.description")}
      </Typography>
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-1">
          <Typography variant="title" size="medium">
            {t("settings.machineLearning.testRequest.request")}
          </Typography>
        ...
        <div className="flex flex-col gap-1">
          <Typography variant="title" size="medium">
            {t("settings.machineLearning.testRequest.response")}
          </Typography>
          <div className="bg-neutral-surface rounded-md p-tight overflow-y-scroll max-h-[400px] min-h-[90px]">
            <pre className="whitespace-pre-wrap break-words text-body-small">
